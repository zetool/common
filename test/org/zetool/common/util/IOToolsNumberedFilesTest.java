...
public class IOToolsNumberedFilesTest {
    ...
    public void failOnInvalidDigits() {
        IOTools.getNextFreeNumberedFilename(baseDirectory.getRoot().getAbsolutePath(), "testfile", 0);
    }

    @Test(expected = IllegalArgumentException.class)
    public void fileInsteadOfPath() {
        IOTools.getNextFreeNumberedFilename(baseDirectory.getRoot().getAbsolutePath() + "/afile", "testfile", 3);
    }

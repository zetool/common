...
public class Debug {
    ...
    static {
        ...
        globalLogger.log(Level.CONFIG, "Logging set up to level {0}", Level.CONFIG);
    }
    ...
    /**
     * A helper method that gives out an exception in a message window to the screen and also gives it out to the
     * default {@code err} stream.
     *

...
/**
 * A list of log entries. Entries can have two types (error and normal messages) and are stored in two ways: in an array
 * and as a string. The error messages have additional html-tags to format them for logging out.
 *
...
public class HTMLLoggerHandler extends StreamHandler {
    ...
    /**
     * Creates an instance, sets up a buffer for output strings and a formatter for proper coloring.
     */

/*
 * StringParameterTemplate.java
 * 
 */
package org.zetool.common.algorithm.template;

/**
 * A class representing algorithmic parameters that take string values and is capable of checking new values against a
 * regular expression.
 *
 * @author Martin Groß
 */
public class StringParameterTemplate extends DefaultParameterTemplate<String> {

    /**
     * A regular expression with which new values have to adhere to. If this is null, checks are omitted.
     */
     ...
     */
    public StringParameterTemplate(String name, String description, String value) {
     ...
     * @param description the description of this parameter.
     * @param value the default value for this parameter.
     * @param regularExpression the regularExpression all values have to match. If this is <code>null</code>, no checks
     * are being performed.
     */
    ...
    /**
     * Returns the regular expression used for validity checks of new values. Can be <code>null</code>, which means that
    ...
    /**
     * Specifies the RegEx that is used to check new values. If it is set to <code>null</code>, the check is omitted.
     *
     *
    ...
    /**
     * Checks whether the specified value matches the regular expression this parameter is using (unless it is
     * <code>null</code>, in which case all values are accepted).
     *
